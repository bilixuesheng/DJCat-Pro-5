...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QFileDialog, QScroller, QLabel)
from qfluentwidgets import (TitleLabel, ToolButton, MessageBoxBase, SubtitleLabel,
                            TimePicker, LineEdit, ComboBox, SpinBox, ExpandSettingCard,
                            SwitchButton, PushButton, BodyLabel, PillPushButton, 
                            SettingCard, FluentIcon as FIF, PickerColumnFormatter)
...
class TaskCard(ExpandSettingCard):
    ...
    def __init__(self, data, parent=None):
        ...
        original_select = self.formWidgets['fileBtn'].clicked.disconnect()
        def _new_select():
